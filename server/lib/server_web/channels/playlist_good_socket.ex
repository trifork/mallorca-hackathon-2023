...
defmodule ServerWeb.PlaylistGoodSocket do
  @moduledoc """
  ...
  def websocket_init(state) do
    with {:ok, player_state} <- PlayerStateServer.get_current_state() do
  ...
  def websocket_handle({"PlaySongAt", %{"at" => song_index}}, state) do
